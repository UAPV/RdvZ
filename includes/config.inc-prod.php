...
define("DataBase", "mysql://rdvz:rdvZfinalementOK@sql01c.univ-avignon.fr/rdvz"); //BDD de l'application
...
define("admin_mail","rdvz-admin@univ-avignon.fr"); //e-mail de l'administrateur
