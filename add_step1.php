...
ini_set('include_path',$newpath);
  ...
  if (isset($_POST['submit']))
  {
	...
	if (isset($_POST['comments'])) //Autoriser ou non les commentaires globaux
		$commentsrdv=$_POST['comments'];
	if (isset ($_POST['commentsdate']))//Autoriser ou non les commentaires par date
	    $commentsdate=$_POST['commentsdate'];
    ...
    if (trim($meeting_title)!='')
    {
      ...
      $_SESSION["commentsrdv"]=$commentsrdv;
      $_SESSION["commentsdate"]=$commentsdate;
