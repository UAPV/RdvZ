...
<div class="buttons">
	...
	oButton.addListener("checkedChange",obc);
			...
			<!-- Activer/desactiver commentaires -->
			<p>
			<?php tr('Available comments');?><br/>
 			<input type="radio" name="comments" value="Y" <?php echo ($tpl_data['comments']=="Y")? 'checked="true"':'';?>><?php tr('Yes')?></input>
 			<input type="radio" name="comments" value="N" <?php if (isset($tpl_data['comments'])){echo ($tpl_data['comments']=="N")? 'checked="true"':'';}else{echo 'checked="true"';}?>><?php tr('No')?></input>
 			</p>			
			
			
			<!-- Activer/desactiver commentaires par date-->
			<p>
			<?php tr('Available date comments');?><br/>
 			<input type="radio" name="commentsdate" value="Y" <?php echo ($tpl_data['comments_date']=="Y")? 'checked="true"':'';?>><?php tr('Yes')?></input>
 			<input type="radio" name="commentsdate" value="N" <?php if (isset($tpl_data['comments_date'])){echo ($tpl_data['comments_date']=="N")? 'checked="true"':'';}else{echo 'checked="true"';}?>><?php tr('No')?></input>
 			</p>			
