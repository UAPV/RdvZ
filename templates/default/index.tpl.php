...
?>
          <tr>
            ...
            <td class="column-action">
              ...
              <span class="delete-link"><a href="del.php?mid=<?php echo $rdv['code']; ?>" onclick="return confirm('<?php echo addslashes(tr('Do you really want to delete this meeting?',1)); ?>');"><?php tr('Delete'); ?></a></span>
