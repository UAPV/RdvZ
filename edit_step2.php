<?php
  ...
  //PremiÃ¨rement on vÃ©rifie si des variables on dÃ©jÃ  Ã©tÃ© envoyÃ©es pour le mois et l'annÃ©e 
  //mois
  if (!isset($_GET["m"])) {
      $m = date("n");
  }
...
<div id="container">
  <form id="form1" name="form1" method="post" action="edit_step2.php">
	...
	<?php
		...
		// si mois précedents et dans l'année et que le mois n'est pas passé
		...
		// si mois suivant et dans l'année et que le mois n'est pas passé
