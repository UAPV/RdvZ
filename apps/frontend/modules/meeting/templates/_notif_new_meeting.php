...
Vous pouvez indiquer vos disponibilités en vous rendant à l'adresse suivante : http://<?php echo sfConfig::get('app_url').url_for('meeting/'.$action.'?h='.$meeting->getHash()) ?> .
