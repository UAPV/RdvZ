...
<input type="text" id="m_search" class="search" name="h" value="Entrez le code d'un rendez-vous pour le visionner..." />
</form>
</fieldset>
...
<table class="my_meetings">
  ...
  <tbody>
    ...
    <tr class="<?php echo $i++%2 ? 'even' : 'odd' ?>">
      ...
      <div><a href="<?php echo url_for('meeting/csv?h='.$meeting->getHash()) ?>"><img class="icon_16" src="/images/page_table_chart_16.png" alt="Exporter csv" /> Exporter au format csv</a></div>
      ...
      <div><a href="<?php echo url_for('meeting/voteclose?h='.$meeting->getHash()) ?>"><?php echo $meeting->getClosed() ? '<img class="icon_16" src="/images/lock_16.png" alt="Rouvrir les votes" /> Rouvrir les votes' : '<img class="icon_16" src="/images/lock_open_16.png" alt="Clore les votes" /> Clore les votes' ?></a></div>
      </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
