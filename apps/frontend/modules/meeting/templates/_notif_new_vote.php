...
<?php echo __("Vous pouvez consulter les nouveaux votes en vous rendant à l'adresse suivante") ?> : http://<?php echo sfConfig::get('app_url').url_for('auth/mh?m='.$meeting->getHash()) ?> .
