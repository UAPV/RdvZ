...
class meetingForm extends BasemeetingForm
{
  ...
  public function configure()
  {
    ...
    {
      $this->widgetSchema['input_date_'.$i] = new rdvzWidgetFormInputDateText(array(),array('class' => 'dynamic_date', 'size' => '10', 'readonly' => 'readonly')) ;
  ...
  {
    $w = new rdvzWidgetFormInputDateText(array(), array('class' => 'dynamic_date', 'size' => '10', 'readonly' => 'readonly')) ;
    return $w ;
  }
